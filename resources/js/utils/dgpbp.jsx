...
export const DGPBP = {
    contactInfo: {
        address: "PORTS CONTENEURS DE CONAKRY, KALOUM REP. DE GUINEE",
        phone: "+224 655 358 284",
        unespace_phone: "+224655358284",
        phones: [
            "+224 655 358 284",
            "+224 611 981 928",
        ],
        ...
        email: "contact@dgpbp.com",
        emails: [
            "contact@dgpbp.com",
            "serviceacceuil@dgpbp.com",
        ],
        hours: {
