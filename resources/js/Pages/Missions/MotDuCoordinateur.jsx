    ...
    <AppLayout>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-6xl font-extrabold bg-gradient-to-bl from-yellow-200 to-yellow-600 bg-clip-text text-transparent mb-6">
