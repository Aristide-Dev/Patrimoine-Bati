...
export default function Create({ communes, statuts }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.property-managers.store'), {
            forceFormData: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Nouveau Gérant Immobilier" />

            <div className="container mx-auto py-6">
                <div className="max-w-3xl mx-auto">
                    <h1 className="text-3xl font-bold text-gray-900 mb-6">Nouveau Gérant Immobilier</h1>

                    <form onSubmit={handleSubmit}>
                        <Card className="mb-6">
                            <CardHeader>
                                <CardTitle>Informations Personnelles</CardTitle>
                                <CardDescription>Entrez les informations de base du gérant</CardDescription>
                            </CardHeader>
                        ...
                        <Card className="mb-6">
                            <CardHeader>
                                ...
                                <CardDescription>Détails sur la commune et les responsabilités</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
                        ...
                        <Card className="mb-6">
                            <CardHeader>
                                ...
                                <CardDescription>Données de gestion immobilière</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                        ...
                        <Card className="mb-6">
                            <CardHeader>
                                ...
                                <CardDescription>Photo de profil et état du compte</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
